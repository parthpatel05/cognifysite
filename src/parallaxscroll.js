...
const ParallaxScroll = () => {
  ...
  const scrollToService = () => {
    console.log("scrollToService function called"); // Add this line
  ...
  return (
    <div
      style={{
        position: "relative",
        height: activeIndex === 2 ? "150vh" : "100vh",
        overflow: "hidden",
    ...
    >
      ...
      <div style={{ backgroundColor: "white", height: 80, position: "sticky" }}>
        ...
        >
          <div
            style={{ margin: 10, color: hoverHome ? "#9A9AFF" : "black" }}
            onMouseEnter={() => {
              setHoverHome(true);
            }}
            onMouseLeave={() => {
          ...
          <div
            style={{ margin: 10, color: hoverSer ? "#9A9AFF" : "black" }}
            onMouseEnter={() => {
              setHoverSer(true);
            }}
            onMouseLeave={() => {
          ...
          <div
            style={{ margin: 10, color: hoverFea ? "#9A9AFF" : "black" }}
            onMouseEnter={() => {
              setHoverFea(true);
            }}
            onMouseLeave={() => {
          ...
          <div
            style={{ margin: 10, color: hoverPrice ? "#9A9AFF" : "black" }}
            onMouseEnter={() => {
              setHoverPrice(true);
            }}
            onMouseLeave={() => {
          ...
          <div
            style={{ margin: 10, color: hoverFaq ? "#9A9AFF" : "black" }}
            onMouseEnter={() => {
              setHoverFaq(true);
            }}
            onMouseLeave={() => {
          ...
          <div
            style={{ margin: 10, color: hoverPage ? "#9A9AFF" : "black" }}
            onMouseEnter={() => {
              setHoverPage(true);
            }}
            onMouseLeave={() => {
      ...
      <div>
        <AnimatePresence initial={false}>
          {components.map((Component, index) => (
            ...
            >
               {index === 0 && (
                <Component mobile={false} scrollToService={scrollToService} />
              )}
              {index !== 0 && <Component />}
